 (function () {
     ...
     (function () {
         ...
         $jit.Canvas = l = new q({
             ...
             initialize: function (L, E) {
                 //Add width height, to calculate px in %
                 $jit.width=document.getElementById(E.injectInto).offsetWidth;
                 $jit.height=document.getElementById(E.injectInto).offsetHeight;
                 ...
                 this.element = x("div", {
                     ...
                     style: {
                         position: "relative",
                         width: "100%", //D*100/$jit.width + "%",
                         height: "100%" //M*100/$jit.height + "%"
                     }
                 });
             ...
             resize: function (D, z) {
                 ...
                 if (this.labelContainer) {
                     this.labelContainer.style.width = "100%"; //D + "px"
                 }
             },
         ...
         l.Base["2D"] = new q({
             ...
             resize: function (C, z) {
                 ...
                 A.width = C;
                 A.height = z;
                 D.width = C*100/$jit.width + "%"; //px
                 D.height = z*100/$jit.height + "%"; //px
                 if (!y) {
             ...
             z.eachNode(function (D) {
                 ...
                 if (H || I) {
                     ...
                     var B = D.getData("width"),
                         J = D.getData("height");
                     y.width = H ? "auto" : B*100/$jit.width + "%"; //px
                     y.height = I ? "auto" : J*100/$jit.height + "%"; //px
                     w.innerHTML = D.name;
                     var F = w.offsetWidth,
                         C = w.offsetHeight;
     ...
     $jit.ST.Label.DOM = new q({
         ...
         placeLabel: function (P, J, F) {
             ...
             var L = P.style;
             L.left = G.x*100/document.width + "%"; //px
             L.top = G.y*100/dopcument.height + "%"; //px
             ...
             var z = new $jit.ST({
                 ...
                 onCreateLabel: function (J, G) {
                     ...
                     if (G.getData("prev")) {
                         ...
                         J.style.width = G.getData("width")*100/$jit.width + "%"; //px
                         J.style.height = G.getData("height")*100/$jit.height + "%"; //px
                         N.innerHTML = G.name;
                         J.appendChild(D)
                     }
                 },
                 onPlaceLabel: function (V, P) {
                     ...
                     if (J && G) {
                         ...
                         E.width = O.width = D.width = V.style.width = M*100/$jit.width + "%"; //px
                         O.left = D.left = (-M / 2)*100/document.width + "%"; //px
                         ...
                         O.top = (-I - x.labelOffset)*100/document.height + "%"; //px
                         D.top = (x.labelOffset + U)*100-document.height + "%"; //px
                         V.style.top = parseInt(V.style.top, 10) - U + "px";
                         V.style.height = E.height = U*100/$jit.height + "%"; //px
         ...
         initializeViz: function () {
             ...
             var z = new $jit.ST({
                 ...
                 onCreateLabel: function (J, H) {
                     ...
                     G.textAlign = "center";
                     I.position = K.position = "absolute";
                     J.style.width = H.getData("width")*100/$jit.width + "%"; //px
                     J.style.height = H.getData("height")*100/$jit.height + "%"; //px
                     I.left = K.left = "0px";
                     O.innerHTML = H.name;
                     J.appendChild(E)
                 },
                 onPlaceLabel: function (U, P) {
                     ...
                     var T = A[P.id],
                         ...
                         N = U.style;
                     if (K && I) {
                         G.width = O.width = E.width = U.style.width = M*100/$jit.width + "%"; //px
                         ...
                         if (x.orientation == "horizontal") {
                             ...
                             O.top = E.top = ((L - J) / 2)*100/document.height + "%"; //px
                             U.style.height = G.height = L*100/$jit.height + "%" //px
                         } else {
                             O.top = (-J - x.labelOffset)*100/document.height + "%"; //px
                             E.top = (x.labelOffset + L)*100/document.height + "%"; //px
     ...
     var v = $jit.TM; $jit.TM.$extend = true; v.Base = {
         ...
         placeLabel: function (H, B, C) {
             ...
             w.left = A.x + "px";
             w.top = A.y + "px";
             w.width = B.getData("width") * G*100/$jit.width + "%"; //px
             w.height = B.getData("height") * E*100/$jit/height + "%"; //px
